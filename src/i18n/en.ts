const en: { [key: string]: string } = {
  ...
  "Classic McDonald's": "Classic McDonald's",
  McBacon: "McBacon",
  "Dbl Quarter Pounder®": "Double Quarter Pounder®",
  "Double Cheeseburger": "Double Cheeseburger",
  "BBQ Burger": "BBQ Burger",

  McPollo: "McPollo",
  "McCrispy Deluxe": "McCrispy Deluxe",
  "McCrispy Spicy": "McCrispy Spicy",
  "McCrispy CBO": "McCrispy CBO",
  "McNuggets 4": "McNuggets 4",
  "McNuggets 6": "McNuggets 6",
  "McNuggets 10": "McNuggets 10",
  "McNuggets 20": "McNuggets 20",
  "Jalapeño Chicken": "Jalapeño Chicken",
  "McCrispy Deluxe Combo": "McCrispy Deluxe Combo",
  "McCrispy Spicy Combo": "McCrispy Spicy Combo",
  "Cheeseburger Combo": "Cheeseburger Combo",
  "Double Quarter Pounder® Combo": "Double Quarter Pounder® Combo",
  "Big Mac® Combo": "Big Mac® Combo",
  "McBacon Combo": "McBacon Combo",
  "Quarter Pounder® with Cheese Combo": "Quarter Pounder® with Cheese Combo",
  "BBQ Burger Combo": "BBQ Burger Combo",
  "Double Cheeseburger Combo": "Double Cheeseburger Combo",
  ...
  "Crispy chicken with bacon, cheese, and onions on a toasted bun.":
    "Crispy chicken with bacon, cheese, and onions on a toasted bun.",
  "4 tender chicken nuggets, golden and crispy.":
    "4 tender chicken nuggets, golden and crispy.",
  "6 crispy chicken nuggets perfect for a snack or meal.":
    "6 crispy chicken nuggets perfect for a snack or meal.",
  "10 chicken nuggets with a crispy outside and juicy inside.":
    "10 chicken nuggets with a crispy outside and juicy inside.",
  "20-piece nuggets perfect for sharing or big appetites.":
    "20-piece nuggets perfect for sharing or big appetites.",
